...
public class OrderDaoImpl implements OrderDao {
  ...
  public boolean addOrder(Orderrs o, LineItemss l[]) {
    int order=0,line=0;
    try (PreparedStatement ps = MySqlConnection.createConnection().prepareStatement("insert into Orders values(?,?,default,?)");
            PreparedStatement ps1 = MySqlConnection.createConnection().prepareStatement("insert into line_item values(?,?,?,?,?)");) {
