...
public class ProductDaoImpl implements ProductDao {
    ...
    public Inventoryy getProductDetails(int product_id) {
        ...
        try {
            ...
            PreparedStatement ps_e = KhataBookDaoImpl.getDataSource().getConnection().prepareStatement(viewQuery);
...
//      inv.setPrice(rs3.getDouble(4));
    ...
    public void stockUpdate(Inventoryy inv) {
        try (
                PreparedStatement ps_h = KhataBookDaoImpl.getDataSource().getConnection().prepareStatement("update product set quantity=? where product_id=?");) {
    ...
    public int addProduct(Inventoryy p) {
        ...
        try (Connection con = KhataBookDaoImpl.getDataSource().getConnection()) {
    ...
    public List<Inventoryy> viewProduct(int productId) {
        ...
        String viewQuery = "select * from product where product_id=?";
        try (
                Connection con = KhataBookDaoImpl.getDataSource().getConnection(); PreparedStatement ps_e = con.prepareStatement(viewQuery);) {
    ...
    public int updateProduct(Inventoryy i) {
        ...
        try (
                Connection connection = KhataBookDaoImpl.getDataSource().getConnection(); PreparedStatement ps_c = connection.prepareStatement(updQuery);) {
    ...
    public List<Inventoryy> viewAll() {
        ...
        try (
                Connection con = KhataBookDaoImpl.getDataSource().getConnection(); PreparedStatement ps_d = con.prepareStatement(view_all);) {
