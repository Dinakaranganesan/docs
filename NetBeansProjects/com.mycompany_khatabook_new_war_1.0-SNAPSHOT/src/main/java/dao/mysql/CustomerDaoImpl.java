...
public class CustomerDaoImpl implements CustomerDao {
    ...
    public int addCustomer(Customerr c) {
        ...
        int ret = 0;
        try (Connection con = KhataBookDaoImpl.getDataSource().getConnection(); PreparedStatement ps_a = con.prepareStatement(addCust);) {
    ...
    public int updateCustomer(Customerr customerr) {
        ...
        try (Connection con = KhataBookDaoImpl.getDataSource().getConnection(); PreparedStatement ps_b = con.prepareStatement(updQry);) {
    ...
    public List<Customerr> viewCustomer(String mobileNumber) {
        ...
        try (Connection con = KhataBookDaoImpl.getDataSource().getConnection(); PreparedStatement ps_a = con.prepareStatement(viewQuery)) {
    ...
    public List<Customerr> viewAll() {
        ...
        try (Connection con = KhataBookDaoImpl.getDataSource().getConnection(); PreparedStatement ps_c = con.prepareStatement(view_all)) {
    ...
    public Customerr getCusdetails(String phone_no) {
        Customerr cus = null;
        try (
            Connection connection = KhataBookDaoImpl.getDataSource().getConnection();
