...
public class Customer {
  ...
  private int cusId;
  @NotBlank
  @Size( min = 3,max = 45,message = "length should between {min} and {max} characters ")
  ...
  public Customer(int cusId, String cusName, String phoneNo, String cusAadhaar, String cusAddress, double cusBal) {
    this.cusId = cusId;
