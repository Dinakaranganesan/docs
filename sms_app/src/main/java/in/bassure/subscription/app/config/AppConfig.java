...
public class AppConfig {
    ...
    private final static int PLAN_DETAIL_LIST_MIN_LEN = 4;
    private final static int PLAN_DETAIL_LIST_MAX_LEN = 90;

    public static int getPLAN_DETAIL_LIST_MIN_LEN() {
        return PLAN_DETAIL_LIST_MIN_LEN;
    }

    public static int getPLAN_DETAIL_LIST_MAX_LEN() {
        return PLAN_DETAIL_LIST_MAX_LEN;
    }

    public static int getPLAN_DETAIL_VALUE_MIN_LEN() {
        return PLAN_DETAIL_VALUE_MIN_LEN;
    }

    public static int getPLAN_DETAIL_VALUE_MAX_LEN() {
        return PLAN_DETAIL_VALUE_MAX_LEN;
    }

    public static int getPLAN_DETAIL_DESCRIPTIVE_MIN_LEN() {
        return PLAN_DETAIL_DESCRIPTIVE_MIN_LEN;
    }

    public static int getPLAN_DETAIL_DESCRIPTIVE_MAX_LEN() {
        return PLAN_DETAIL_DESCRIPTIVE_MAX_LEN;
    }

    private final static int PLAN_DETAIL_VALUE_MIN_LEN = 3;
    private final static int PLAN_DETAIL_VALUE_MAX_LEN = 20;

    private final static int PLAN_DETAIL_DESCRIPTIVE_MIN_LEN = 10;
    private final static int PLAN_DETAIL_DESCRIPTIVE_MAX_LEN = 200;
